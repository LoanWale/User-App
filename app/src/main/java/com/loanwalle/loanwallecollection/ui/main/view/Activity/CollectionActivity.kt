  ...
  if (radi_discount.isChecked)
            ...
            override fun onTextChanged(s: CharSequence, start: Int,
                        ...
                        if (Total_Payable_Amount < principlea.text.toString())
                    {
                      ...
                      else if (Total_Payable_Amount == principlea.text.toString())
                        {
                            ...
                            val unpaidamount2:Int= Total_Payable_Amount.toInt() - principlea.text.toString().toInt()
                            unpaidamount.setText(unpaidamount2.toString())
                        }else if (Total_Payable_Amount > principlea.text.toString() && principlea.text.toString().toInt() >=1)
                        {
                        ...
                        is Resource.Success -> {
                            ...
                            response.data?.let { otpResponse ->
                                ...
                                if (message.equals("success")&&otpResponse.status.equals("200"))
                                {
                                    ...
                                    Total_Payable_Amount = otpResponse.data.payable_amount.toString()
                                    net_disbursal_amount = otpResponse.data.net_disbursal_amount.toString()
    ...
    fun update_Loan_Detils() {
        ...
        if (userid!=null) {
            ...
            unpaidamount.text.toString(), Latitude.toString(),
                Longitude.toString(), "12-08-2021",
                "12:10 AM", "1",
                Collection_Remark.text.toString(), "2021-07-12",
                principlea.text.toString(), paymentstatus,
                "1", Collection_Remark.text.toString(),
                Edit_KM.text.toString(), user,
                "noida 15",closertype)
